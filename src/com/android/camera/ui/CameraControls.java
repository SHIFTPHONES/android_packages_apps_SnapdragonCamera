...
public class CameraControls extends RotatableLayout {
    ...
    private static final int SWITCHER_INDEX = 4;
    private static final int SHUTTER_INDEX = 5;
    private static final int PREVIEW_INDEX = 6;
    private static final int INDICATOR_INDEX = 7;
    private static final int MUTE_INDEX = 8;
    private static final int VIDEO_SHUTTER_INDEX = 9;
    private static final int EXIT_PANORAMA_INDEX = 10;
    ...
    public void enableTouch(boolean enable) {
        ...
        mPreviewProgress.setEnabled(enable);
    ...
    private void resetLocation(float x, float y) {
        ...
        mPreviewProgress.setX(mLocX[idx1][PREVIEW_INDEX] - x);
        ...
        mPreviewProgress.setY(mLocY[idx1][PREVIEW_INDEX] - y);
    }
    ...
    public void hideUI() {
        ...
        mPreviewProgress.animate().cancel();
        ...
        switch (rotation) {
            case 0:
                ...
                mPreviewProgress.animate().translationYBy(mSize).setDuration(ANIME_DURATION);
                break;
            case 90:
                ...
                mPreviewProgress.animate().translationXBy(mSize).setDuration(ANIME_DURATION);
                break;
            case 180:
                mFrontBackSwitcher.animate().translationYBy(mSize).setDuration(ANIME_DURATION);
                mHdrSwitcher.animate().translationYBy(mSize).setDuration(ANIME_DURATION);
